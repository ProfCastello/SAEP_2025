...
namespace Prova02.Controllers
{
    public class MovimentacoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MovimentacaoId,ProdutoId,UsuarioId,Quatidade,Tipo")] Movimentacao movimentacao)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    produto.EstoqueAtual += movimentacao.Quatidade;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MovimentacaoId,ProdutoId,UsuarioId,Quatidade,Tipo")] Movimentacao movimentacao)
        {
